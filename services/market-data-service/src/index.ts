...
import './models/ListedCompany';  // enregistre le modèle
import './models/PriceHistory';   // enregistre le modèle + association
...
async function start() {
  try {
    ...
    // Crée les tables si elles n'existent pas (ne modifie pas les colonnes existantes)
